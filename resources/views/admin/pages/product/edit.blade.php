                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                                aria-controls="pills-profile" aria-selected="false">{{ __('France')}}</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-content slider-page-form" id="pills-tabContent">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <a href="{{route('admin.product')}}"
                                    class="btn btn-md btn-primary text-right">{{ __('All Products')}}</a>
                            </div>
                            <div class="card-body ">
                                <form enctype="multipart/form-data" method="POST"
                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="en_category_name" disabled>
                                                <option value="">{{__('---SELECT A CATEGORY---')}}</option>
                                                @foreach(Category() as $item)
                                                    <option value="{{$item->id}}" {{$item->id == $product->Category_Id ? 'selected' : ''}}>{{$item->en_Category_Name}}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" name="en_category_name" value="{{$product->Category_Id}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="en_about" id="en_about"
                                                class="form-control summernote">{!! clean($product->en_About) !!}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ __('Description')}}</label>
                                            <textarea name="en_description" id="en_description"
                                                class="form-control summernote">{!! clean($product->en_Description) !!}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ __('ShippingReturn')}}</label>
                                            <textarea name="en_shippingreturn" id="en_shippingreturn"
                                                class="form-control summernote">{!! clean($product->en_ShippingReturn) !!}</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control putImage1" name="primary_image"
                                                id="primary_image">
                                            <img class="admin_image" src="{{asset(ProductImage() . $product->Primary_Image)}}"
                                                id="target1" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control putImage2" name="image_two"
                                                id="image_two">
                                            <img class="admin_image" src="{{asset(ProductImage() . $product->Image2)}}"
                                                id="target2" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control putImage3" name="image_three"
                                                id="image_three">
                                            <img class="admin_image" src="{{asset(ProductImage() . $product->Image3)}}"
                                                id="target3" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control putImage4" name="image_four"
                                                id="image_four">
                                            <img class="admin_image" src="{{asset(ProductImage() . $product->Image4)}}"
                                                id="target4" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control putImage5" name="image_five"
                                                id="image_five">
                                            <img class="admin_image" src="{{asset(ProductImage() . $product->Image5)}}"
                                                id="target5" />
                                        </div>

                                        <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" value="1" {{$product->Status == 1 ? 'checked' : ''}}
                                                    name="status" class="custom-control-input" id="customSwitch1">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" value="1" {{$product->On_Sale == 1 ? 'checked' : ''}}
                                                    name="on_sale" class="custom-control-input" id="customSwitch4">
                                                <label class="custom-control-label"
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ __('About')}}</label>
                                            <textarea name="fr_about" id="fr_about"
                                                class="form-control">{{ $product->fr_About }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ __('Description')}}</label>
                                            <textarea name="fr_description" id="fr_description"
                                                class="form-control summernote">{!! clean($product->fr_Description) !!}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ __('ShippingReturn')}}</label>
                                            <textarea name="fr_shippingreturn" id="fr_shippingreturn"
                                                class="form-control summernote">{!! clean($product->fr_ShippingReturn) !!}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{ __('AdditionalInformation')}}</label>
