                                ...
                                <div class="col-md-6">
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <form method="POST"
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="experts_email">{{ __('Experts Email') }}</label>
                                                <input type="email" class="form-control" id="experts_email"
                                                    name="experts_email"
                                                    value="{{ @$allsettings['experts_email'] }}">
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="contact_map_iframe">{{ __('Contact Page Map Iframe URL') }}</label>
                                                <textarea class="form-control" id="contact_map_iframe" name="contact_map_iframe" rows="3">{{ @$allsettings['contact_map_iframe'] }}</textarea>
...
@push('post_scripts')
    <script>
        $('#shipping_free_text').on('input', function() {
            $('#shipping_charge').val(0);
        });
        $('#shipping_charge').on('input', function() {
            $('#shipping_free_text').val('');
        });
    </script>
@endpush
