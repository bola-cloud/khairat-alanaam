...
@section('title', app()->getLocale() == 'ar' ? 'خطأ 419' : 'Error 419')
...
<div class="v2-container" style="padding: 100px 0; text-align: center; min-height: 500px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
    <div style="max-width: 600px;">
        ...
        <h1 style="font-size: 60px; font-weight: 900; color: #333; margin-bottom: 10px;">419</h1>
        ...
        <p style="font-size: 16px; color: #666; margin-bottom: 40px; line-height: 1.6;">
            {{ app()->getLocale() == 'ar' ? 'انتهت صلاحية الجلسة بسبب عدم النشاط. يرجى تحديث الصفحة والمحاولة مرة أخرى.' : 'The page has expired due to inactivity. Please refresh and try again.' }}
        </p>
